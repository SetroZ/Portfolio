    ...
    return(
        <div className="flex flex-row m-12 gap-3">
            <div className="flex flex-col items-center  ">
                ...
                <div  className={`m-[-2px] w-1 h-[400px]  rounded-full bg-purple-500 fade`}></div>
            </div>
            <div className="flex flex-col gap-2 ">
                <h2 className="font-extrabold  text-6xl ">Hi, I am Vetro</h2>
                <h2 className="font-extrabold  text-6xl  ">I am a 
